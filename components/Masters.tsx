...
type MasterDef = {
  ...
  /** Mobile object-position (<768px carousel). */
  posNarrow: string;
  /** Desktop/tablet object-position (md+ flex rows). */
  posWide: string;
};
...
const MASTER_LIST: readonly MasterDef[] = [
  ...
  { nameKey: "masters.n.danya", titleKey: "masters.danya.title", descKey: "masters.danya.desc", image: "/masters/danya.png", altKey: "masters.portrait.danya", posNarrow: "50% 0%", posWide: "50% 22%" },
  ...
  { nameKey: "masters.n.mariia", titleKey: "masters.mariia.title", descKey: "masters.mariia.desc", image: "/masters/mariia.png", altKey: "masters.portrait.mariia", posNarrow: "center top", posWide: "50% 10%" },
  { nameKey: "masters.n.iryna", titleKey: "masters.iryna.title", descKey: "masters.iryna.desc", image: "/masters/iryna.png", altKey: "masters.portrait.iryna", posNarrow: "center top", posWide: "50% 10%" },
] as const;
